...
| 2026-06-16 | fix-unused-parameters-2026-06-16 (off develop@6169049ef) | 208→161 | **47→0** | 161 | 0 | 0 | 47 (30 files) | **0** | **0** | 3/3 | **CONVERGING ✅ — unused parameters renamed, committed `88a8c5f11`.** Treeswift rebuilt fresh (dylib 15:49, newer than CodeModificationHelper.swift 15:40 — d55d6c07 param-rename fix). Cold scan confirmed floor: unused=47, assignOnly=161, redunAcc=0, total=208. forceRemoveAll: 47 parameter renames across 30 files (0 deletions; rename-to-`_` only), build_errors=0 (BUILD SUCCEEDED). Committed `88a8c5f11` ("Rename 47 unused function parameters to _"; 30 files changed, 46 ins / 49 del). Cold rescan after commit: **unused=0**, assignOnly=161, redunAcc=0, total=161. Both convergence conditions now met: forceRemoveAll→build_errors=0; genuine unused→0. Remaining floor: assignOnly=161 (design floor, no automated removal). Branch ready for PR. |
